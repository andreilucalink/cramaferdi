    ...
    <div className='single-product-container bg-francisc'>
      ...
      <div className='single-product-desc'>
        ...
        <div className='text-desc'>
          Cabernet Franc și Merlot, două soiuri de struguri care se completează
          perfect într-un blend ce oferă un caracter unic, un potențial bun de
          învechire și o comoară artizanală. Vinul este plăcut pentru aromele
          sale intense, aciditatea medie spre înaltă și gustul ierbos. Anul
          recoltei este 2017 iar maturarea a avut loc timp de 18 luni în butoaie
          de stejar. Gradul alcoolic este 14,9%.
          <br />
          <b>
