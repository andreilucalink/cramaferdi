        ...
        <div className="home-body">
            ...
            <div className="home-section1">
                ...
                <div className="home-section-content1">
                    ...
                    <p>
                        <strong>Crama Ferdi</strong> este o cramă de tip
                        boutique – premium care oferă iubitorului de vin
                        privilegiul de a degusta un vin lucrat exclusiv manual
                        și în ediții foarte limitate. Sistemul de vinificație
                        este unul de perspectivă îndelungată, având în vedere că
                        vinurile roșii sunt maturate, de la 1 la 2 ani, în
                        butoaie de stejar american, francez și românesc,
                        reînnoite la fiecare 3 - 4 ani.
                    </p>
            ...
            <div className="home-section3">
                <div className="home-section-content3">
                    ...
                    <p>
                        Via se află în însorita regiune viticolă Dealu Mare, pe
                        o suprafață de 3 hectare și are o vechime de 10 ani.
                        Proprietarul cramei este și cel care face vinul,
                        ghidându-se după deviza că vinul de calitate își are
                        obârșia în vie, de unde începe și selecția strugurilor.
                    </p>
                    <iframe
            ...
            <div className="home-section5">
                <div className="home-section-content5">
                    ...
                    <img src={separator} alt="" className="separator" />
                    <p>
                        Crama produce vin din 10 soiuri de struguri, dintre care
                        7 roșii: Fetească Neagră, Cabernet Sauvignon, Cabernet
                        Franc, Shiraz, Merlot, Burgund Mare, Pinot Noir și 3
                        albe: Sauvignon Blanc, Tămâioasa Românească și Riesling
                        Italian, producția anuală totală fiind aproximativ de
                        10.000 de sticle. <br /> Vinurile Cramei Ferdi se
                        disting prin naturalețe, consistență, aciditate și
                        eleganță. Utilizarea metodei tradiționale de făcut vinul
                        are ca rezultat o gamă de vinuri echilibrate și
                        rafinate.
                    </p>
